...
export const usersRelations = relations(users, ({ many }) => ({
  ...
  practiceTestQuestionsUsersAttempteds: many(
    practiceTestQuestionsUsersAttempted,
  ),
...
export const adhocSessionApproversRelations = relations(
  adhocSessionApprovers,
  ({ one }) => ({
...
export const adhocSessionsRelations = relations(
  adhocSessions,
  ({ one, many }) => ({
    adhocSessionApprovers: many(adhocSessionApprovers),
...
export const adhocSessionBatchesRelations = relations(
  adhocSessionBatches,
  ({ one }) => ({
    adhocSession: one(adhocSessions, {
...
export const adhocSessionBlocksRelations = relations(
  adhocSessionBlocks,
  ({ one }) => ({
    adhocSession: one(adhocSessions, {
...
export const adhocSessionSectionsRelations = relations(
  adhocSessionSections,
  ({ one }) => ({
    adhocSession: one(adhocSessions, {
...
export const adhocSessionUsersRelations = relations(
  adhocSessionUsers,
  ({ one }) => ({
    adhocSession: one(adhocSessions, {
...
export const adhocSessionBlueprintsRelations = relations(
  adhocSessionBlueprints,
  ({ many }) => ({
    adhocSessions: many(adhocSessions),
  }),
...
export const aiPracticeQuestionsRelations = relations(
  aiPracticeQuestions,
  ({ one }) => ({
    lecture: one(lectures, {
...
export const applicationCommentsRelations = relations(
  applicationComments,
  ({ one }) => ({
...
export const assignmentBlueprintsRelations = relations(
  assignmentBlueprints,
  ({ one, many }) => ({
...
export const assignmentBlueprintsProblemsRelations = relations(
  assignmentBlueprintsProblems,
  ({ one }) => ({
...
export const batchInfoStagesRelations = relations(
  batchInfoStages,
  ({ one, many }) => ({
    batchInfos: many(batchInfo),
    batchInfoApprovers: many(batchInfoApprovers),
...
export const batchInfoApproversRelations = relations(
  batchInfoApprovers,
  ({ one }) => ({
    batchInfoStage: one(batchInfoStages, {
...
export const batchInfoHistoryRelations = relations(
  batchInfoHistory,
  ({ one }) => ({
    batch: one(batches, {
...
export const batchInfoTemplateItemsRelations = relations(
  batchInfoTemplateItems,
  ({ one }) => ({
...
export const batchInfoTemplatesRelations = relations(
  batchInfoTemplates,
  ({ many }) => ({
...
export const batchParticipantsRelations = relations(
  batchParticipants,
  ({ one }) => ({
...
export const blockDraftUnitMovementsRelations = relations(
  blockDraftUnitMovements,
  ({ one }) => ({
    block: one(blocks, {
...
export const draftUnitMovementsRelations = relations(
  draftUnitMovements,
  ({ one, many }) => ({
    blockDraftUnitMovements: many(blockDraftUnitMovements),
    section_newSectionId: one(sections, {
...
export const blockUnitMovementEmailsRelations = relations(
  blockUnitMovementEmails,
  ({ one, many }) => ({
    block: one(blocks, {
...
export const certificateTemplateConfigRelations = relations(
  certificateTemplateConfig,
  ({ one }) => ({
...
export const certificateUserRelationRelations = relations(
  certificateUserRelation,
  ({ one }) => ({
    batch: one(batches, {
...
export const certificatesBatchStudentsRelations = relations(
  certificatesBatchStudents,
  ({ one, many }) => ({
    certificateUserRelations: many(certificateUserRelation),
...
export const certificatesTemplateBatchRelations = relations(
  certificatesTemplateBatch,
  ({ one, many }) => ({
...
export const certificatesEmailTemplatesRelations = relations(
  certificatesEmailTemplates,
  ({ one }) => ({
    user_createdBy: one(users, {
...
export const clubPostBookmarksRelations = relations(
  clubPostBookmarks,
  ({ one }) => ({
    post: one(posts, {
...
export const disbursalStatusesRelations = relations(
  disbursalStatuses,
  ({ one }) => ({
    user: one(users, {
...
export const unitMovementRulesRelations = relations(
  unitMovementRules,
  ({ one, many }) => ({
    draftUnitMovements: many(draftUnitMovements),
    section_newSectionId: one(sections, {
...
export const eeEngagementCostsRelations = relations(
  eeEngagementCosts,
  ({ one }) => ({
...
export const externalEmployeesRelations = relations(
  externalEmployees,
  ({ many }) => ({
    eeEngagementCosts: many(eeEngagementCosts),
    eeOnboardingForms: many(eeOnboardingForm),
...
export const eeOnboardingFormRelations = relations(
  eeOnboardingForm,
  ({ one }) => ({
    externalEmployee: one(externalEmployees, {
...
export const eePayoutHistoriesRelations = relations(
  eePayoutHistories,
  ({ one }) => ({
    externalEmployee: one(externalEmployees, {
...
export const electiveEntityRelations = relations(
  electiveEntity,
  ({ one, many }) => ({
...
export const electiveProgressRelations = relations(
  electiveProgress,
  ({ one }) => ({
...
export const electiveUserRelations = relations(
  electiveUser,
  ({ one, many }) => ({
    electiveProgresses: many(electiveProgress),
    elective: one(electives, {
...
export const electiveSectionRelations = relations(
  electiveSection,
  ({ one }) => ({
    batch: one(batches, {
...
export const feedbackQuestionBlueprintsRelations = relations(
  feedbackQuestionBlueprints,
  ({ one, many }) => ({
    feedbackBlueprint: one(feedbackBlueprints, {
...
export const instituteBatchesRelations = relations(
  instituteBatches,
  ({ one }) => ({
    batch: one(batches, {
...
export const interactionMessagesRelations = relations(
  interactionMessages,
  ({ one }) => ({
...
export const topicObjectivesRelations = relations(
  topicObjectives,
  ({ one, many }) => ({
...
export const lectureAiGeneratedContentRelations = relations(
  lectureAiGeneratedContent,
  ({ one }) => ({
    lecture: one(lectures, {
...
export const lectureBlueprintsRelations = relations(
  lectureBlueprints,
  ({ one }) => ({
    blueprint: one(blueprints, {
...
export const sectionFeedbackBlueprintsRelations = relations(
  sectionFeedbackBlueprints,
  ({ one, many }) => ({
    lectureBlueprints: many(lectureBlueprints),
    blueprint: one(blueprints, {
...
export const lectureInteractionsRelations = relations(
  lectureInteractions,
  ({ one }) => ({
    lecture: one(lectures, {
...
export const npsQuestionResponsesRelations = relations(
  npsQuestionResponses,
  ({ one }) => ({
...
export const npsQuestionsRelations = relations(
  npsQuestions,
  ({ one, many }) => ({
...
export const npsSubmissionsRelations = relations(
  npsSubmissions,
  ({ one, many }) => ({
    npsQuestionResponses: many(npsQuestionResponses),
    npsForm: one(npsForms, {
...
export const oldCertsDumpCertificatesRelations = relations(
  oldCertsDumpCertificates,
  ({ one }) => ({
...
export const oldCertsDumpBatchesRelations = relations(
  oldCertsDumpBatches,
  ({ many }) => ({
...
export const participantMetricsRelations = relations(
  participantMetrics,
  ({ one }) => ({
    meeting: one(meetings, {
...
export const placementStatusesRelations = relations(
  placementStatuses,
  ({ one }) => ({
    user: one(users, {
...
export const portfolioFeedbackRelations = relations(
  portfolioFeedback,
  ({ one }) => ({
...
export const portfolioSubmissionsRelations = relations(
  portfolioSubmissions,
  ({ one, many }) => ({
    portfolioFeedbacks: many(portfolioFeedback),
    user: one(users, {
...
export const portfolioStudentIasRelations = relations(
  portfolioStudentIas,
  ({ one }) => ({
    user_iaId: one(users, {
...
export const positionsHistoriesRelations = relations(
  positionsHistories,
  ({ one }) => ({
    position: one(positions, {
...
export const practiceInterviewsRelations = relations(
  practiceInterviews,
  ({ one }) => ({
    user: one(users, {
...
export const practiceQuizResponsesRelations = relations(
  practiceQuizResponses,
  ({ one }) => ({
    user: one(users, {
...
export const practiceTestQuestionsRelations = relations(
  practiceTestQuestions,
  ({ one, many }) => ({
...
export const practiceTestSubTopicsRelations = relations(
  practiceTestSubTopics,
  ({ one, many }) => ({
...
export const practiceTestQuestionsUsersAttemptedRelations = relations(
  practiceTestQuestionsUsersAttempted,
  ({ one }) => ({
...
export const practiceTestTopicsRelations = relations(
  practiceTestTopics,
  ({ many }) => ({
...
export const profileVerifiesRelations = relations(
  profileVerifies,
  ({ one }) => ({
    user_createdBy: one(users, {
...
export const quizBlueprintsRelations = relations(
  quizBlueprints,
  ({ one, many }) => ({
    blueprint: one(blueprints, {
...
export const quizBlueprintsQuestionsRelations = relations(
  quizBlueprintsQuestions,
  ({ one }) => ({
    question: one(questions, {
...
export const studentTagCategoriesRelations = relations(
  studentTagCategories,
  ({ one, many }) => ({
    studentTagCategory: one(studentTagCategories, {
      ...
      relationName:
        'studentTagCategories_parentCategoryId_studentTagCategories_id',
    }),
...
export const studentTagRelationRelations = relations(
  studentTagRelation,
  ({ one, many }) => ({
    studentTagCategory: one(studentTagCategories, {
...
export const studentTagNamesRelations = relations(
  studentTagNames,
  ({ many }) => ({
    studentTagRelations: many(studentTagRelation),
  }),
...
export const studentTagTypesRelations = relations(
  studentTagTypes,
  ({ many }) => ({
    studentTagRelations: many(studentTagRelation),
  }),
...
export const unitMovementUserDetailsRelations = relations(
  unitMovementUserDetails,
  ({ one }) => ({
    section: one(sections, {
...
export const userBlockEmailsRelations = relations(
  userBlockEmails,
  ({ one }) => ({
    block: one(blocks, {
...
export const userRelationRelations = relations(
  userRelation,
  ({ one, many }) => ({
...
export const userRelationHistoryRelations = relations(
  userRelationHistory,
  ({ one }) => ({
    user: one(users, {
...
export const zefFeedbackRatingRelations = relations(
  zefFeedbackRating,
  ({ one }) => ({
