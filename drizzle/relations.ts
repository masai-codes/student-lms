...
export const zefLmsFeedbackSubmissionsRelations = relations(
  zefLmsFeedbackSubmissions,
  ({ one }) => ({
...
export const zefLmsMetaDataRelations = relations(
  zefLmsMetaData,
  ({ one, many }) => ({
    zefLmsFeedbackSubmissions: many(zefLmsFeedbackSubmissions),
...
export const zefLmsPollsQuestionsRelations = relations(
  zefLmsPollsQuestions,
  ({ one, many }) => ({
    zefLmsMetaDatum: one(zefLmsMetaData, {
...
export const zefLmsPollsSubmissionsRelations = relations(
  zefLmsPollsSubmissions,
  ({ one }) => ({
    user: one(users, {
...
export const zefLmsQuizSubmissionRelations = relations(
  zefLmsQuizSubmission,
  ({ one }) => ({
    user: one(users, {
...
export const zefLmsSqlSandboxRelations = relations(
  zefLmsSqlSandbox,
  ({ one }) => ({
    zefLmsMetaDatum: one(zefLmsMetaData, {
