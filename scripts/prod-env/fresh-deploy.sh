...
aws cloudformation deploy --stack-name student-lms-pre-prod --template-file cloudformation.yml --capabilities CAPABILITY_NAMED_IAM\
  --parameter-overrides \
  GoldenAMIId=ami-0be039ca5f9e07370 \
