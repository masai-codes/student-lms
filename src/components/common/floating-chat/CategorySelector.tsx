    ...
    <div className="flex flex-col gap-[9px]">
      {categories.map((cat) => (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <strong className="block text-[14.5px] font-bold text-[#15162c] leading-tight mb-0.5">
              {cat.label}
            </strong>
            <small className="block text-[12.3px] text-[#9496ab] leading-tight">
              {cat.desc}
            </small>
          </div>
      ...
      {onRequestCallback && (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <strong className="block text-[14.5px] font-bold text-[#4b4396] leading-tight mb-0.5">
              Request a Callback
            </strong>
            <small className="block text-[12.3px] text-[#62647d] leading-tight">
