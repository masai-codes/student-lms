  ...
  if (isSubmitted || alreadySubmitted) {
    return (
      <div className="shrink-0 p-6 border-t border-[#e9e9f3] bg-[#f9f9fc] animate-in fade-in slide-in-from-bottom-2 flex flex-col items-center justify-center">
        ...
        <div className="text-[14px] font-bold text-[#15162c] mb-1">
          Feedback Submitted
        </div>
  ...
  if (!rating) {
    return (
      <div className="shrink-0 p-4 border-t border-[#e9e9f3] bg-[#f9f9fc] animate-in fade-in slide-in-from-bottom-2">
        ...
        <div className="flex items-center justify-between bg-white border border-[#e9e9f3] rounded-[12px] p-[14px_16px] shadow-sm">
    ...
    <div className="shrink-0 p-4 border-t border-[#e9e9f3] bg-[#f9f9fc] animate-in fade-in slide-in-from-bottom-2">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="text-[12px] font-bold text-[#4b4396] hover:underline disabled:opacity-50"
        >
          Back
        </button>
      </div>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isSelected
                  ? rating === 'up'
                    ? 'bg-[#f0fdf4] border-[#0E9F6E] text-[#0E9F6E]'
      ...
      {errorMessage && (
        <p className="mb-3 rounded-[10px] bg-[#fef2f2] px-3 py-2 text-[12.5px] font-medium text-[#b42318]">
          {errorMessage}
        </p>
      )}
      ...
      {rating === 'up' ? (
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center p-[13px] rounded-[10px] font-bold text-[13.5px] text-[#62647d] border-[1.5px] border-[#e3e3fb] bg-white hover:bg-[#f0f0fd] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
            Reopen & Escalate
          </button>
        </div>
