...
export default function AppError({ error, reset }: ErrorComponentProps) {
  ...
  return (
    ...
    >
      <div className="flex max-w-md flex-col items-center gap-4 rounded-lg border bg-surface px-6 py-8 text-center shadow-sm">
        ...
        {import.meta.env.DEV ? (
          <details className="w-full text-left" data-testid="app-error-details">
