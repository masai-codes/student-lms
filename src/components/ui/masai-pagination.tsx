...
const cellVariants = cva(
  'inline-flex shrink-0 items-center justify-center bg-surface outline-none transition-colors focus-visible:z-10 focus-visible:ring-2 focus-visible:ring-primary-400 focus-visible:ring-offset-0',
  {
    variants: {
      ...
      interactive: {
        true: 'cursor-pointer hover:bg-surface-muted active:bg-surface-muted',
        false: 'cursor-default',
      },
      state: {
        default: '!text-foreground',
        active: 'bg-blue-50 !text-foreground dark:bg-info-subtle',
...
export function MasaiPagination({
  ...
  return (
    <nav
      ...
      className={cn(
        'inline-flex items-stretch overflow-hidden rounded-lg border border-border bg-surface shadow-[0_1px_2px_rgba(17,25,40,0.04)] divide-x divide-border',
        className,
      )}
      {...props}
    >
