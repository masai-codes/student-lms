...
const fieldShellClassName =
  'relative flex min-h-[40px] min-w-0 w-full items-center rounded-[8px] border border-border bg-surface px-3 text-foreground outline-none transition-[color,border-color,box-shadow] focus-within:border-primary-500 focus-within:ring-2 focus-within:ring-primary-400 focus-within:ring-offset-2 focus-within:ring-offset-background'
      ...
      >
        <input
          ...
          className={cn(
            ...
            'relative z-0 min-h-0 min-w-0 flex-1 bg-transparent py-2 pr-10 text-[15px] text-foreground outline-none [-webkit-appearance:none] [&::-webkit-datetime-edit]:py-0.5 [&::-webkit-datetime-edit-fields-wrapper]:p-0',
        ...
        />
        <span
          className="pointer-events-none absolute right-3 top-1/2 z-10 inline-flex -translate-y-1/2 text-foreground"
          aria-hidden
        >
