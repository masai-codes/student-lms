...
function ModalClose({
  ...
  return (
    <DialogPrimitive.Close
      ...
      className={cn(
        'rounded-md text-foreground-subtle transition-colors hover:text-foreground-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring',
        className,
      )}
      {...props}
    />
