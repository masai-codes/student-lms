...
export function RichTextEditor({
  ...
  return (
    <div className={`discussion-rich-editor relative ${className}`}>
      ...
      {editorState?.isEmpty ? (
        <p
          className={`pointer-events-none absolute left-3 right-3 text-[16px] leading-[22px] text-[#9CA3AF] sm:text-[14px] ${placeholderTopClass}`}
        >
          {placeholder}
        </p>
      ) : null}
      ...
      <Modal open={linkModalOpen} onOpenChange={setLinkModalOpen}>
        ...
        >
          <ModalTitle className="text-[18px] font-bold text-[#111827]">
            {isEditingLink ? "Edit link" : "Add link"}
          </ModalTitle>
          <ModalDescription className="mt-1 text-[13px] text-[#6B7280]">
            {linkNeedsText
            ...
            {linkNeedsText ? (
              <label className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-[#E5E7EB] px-3 py-2.5 text-[14px] text-[#111928] outline-none focus:border-masaiverse-orange focus:ring-2 focus:ring-masaiverse-orange/20"
                />
              </label>
            ) : null}
            <label className="flex flex-col gap-1.5">
            ...
            <div className="mt-1 flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="rounded-[10px] border border-[#E5E7EB] px-4 py-2 text-[13px] font-semibold text-[#374151] hover:bg-[#F9FAFB]"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="rounded-[10px] bg-masaiverse-orange px-4 py-2 text-[13px] font-bold text-white transition-colors hover:bg-masaiverse-orange-dark disabled:opacity-50"
                >
