...
import type { DashboardData, DashboardOverviewState } from '../shared/types'
...
// connected surface.
export function DashboardLayout({ data, overview }: DashboardLayoutProps) {
  return (
    <div data-testid="dashboard-root" className="mx-4 mb-8 mt-4 md:mx-8">
      ...
      >
        <WelcomeSection studentName={data.studentName} banners={overview.banners} />
