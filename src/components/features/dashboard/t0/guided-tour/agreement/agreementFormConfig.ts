...
export type AgreementFieldType =
  'text' | 'email' | 'date' | 'number' | 'select' | 'phone'
...
export const AGREEMENT_FIELDS: Array<AgreementFieldDef> = [
  ...
  },
  {
    ...
    type: 'phone',
    required: true,
    countryKey: 'parentsMobileCountry',
  ...
  },
  {
    ...
    showWhen: (v) => v.currentStatus === 'studying',
  },
  {
    key: 'workDomain',
    label: 'Work Domain',
    ...
    showWhen: (v) => v.currentStatus === 'working',
  },
  {
  ...
  },
  {
    ...
    maxLength: 4,
    placeholder:
      'If you have not completed graduation or are a college dropout, mention the year of completion of your college',
  },
  {
    key: 'collegeName',
    label: 'College Name',
    ...
    required: true,
    placeholder:
      'If you are not currently studying, mention the last studied college / school name',
  },
  {
    key: 'companyName',
  ...
  {
    key: 'passportNumber',
    label: 'Passport Number (for international students only)',
    type: 'text',
