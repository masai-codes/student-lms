...
function BookmarkCard({ item }: { item: BookmarkItem }) {
  ...
  const cardClass =
    'flex items-center gap-3 p-4 rounded-xl border border-border bg-surface transition-shadow hover:shadow-md no-underline'
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-24 gap-4">
      <Bookmark size={48} strokeWidth={1} className="text-foreground-subtle" />
    ...
    <div className="mx-4 mb-6 mt-4 md:mx-8 flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            type="button"
            className="flex items-center justify-center w-10 h-10 rounded-xl border border-border bg-surface text-foreground-muted hover:bg-surface-muted transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 cursor-pointer"
          >
