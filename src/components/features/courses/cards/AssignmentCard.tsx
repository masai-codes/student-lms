  ...
  return (
    <div onClick={handleClick} className="block">
      <div className='flex items-start gap-2 flex-1 bg-white border border-[#E5E7EB] rounded-lg p-3'>
        <img className='mt-[0.25em] h-8 px-2' src='/AssignmentIcon.svg' alt="Lecture-icon" />
        <div>
          ...
          <div className='flex items-center gap-2 text-sm font-medium mt-2'>
            ...
            <p className='text-[#4B5563]'>{formatSqlDate(assignment.schedule)}</p>
          </div>
          <div className='flex items-center gap-2 text-sm font-medium mt-2'>
            <p className='bg-[#F9FAFB] p-1 rounded-xl text-[#6C7280]'>{capitalize(assignment.category)}</p>
            ...
            {/* <p className='bg-[#F9FAFB] p-1 rounded-xl text-[#6C7280]'>{assignment.module}</p> */}
          </div>
        </div>
      </div>
    </div>
