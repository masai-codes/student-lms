  ...
  return (
    <div className="relative">
      ...
      {copied ? (
        ...
        >
          <span className="absolute -top-1.5 right-7 size-3 rotate-45 rounded-[2px] border-l border-t border-black/5 bg-white" />
          <div className="flex items-center gap-3 rounded-[14px] border border-black/5 bg-white px-4 py-3 shadow-[0_16px_40px_-8px_rgba(0,0,0,0.35)]">
            <span className="flex size-9 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#23C16B] to-[#1FA463] text-white shadow-[0_4px_10px_rgba(31,164,99,0.35)]">
              <CheckCircle size={22} weight="fill" />
            </span>
            <span className="min-w-0">
              <span className="block text-[14px] font-bold leading-5 text-[#111827]">
                Link copied!
              </span>
              <span className="flex items-center gap-1 text-[12px] leading-4 text-[#6B7280]">
