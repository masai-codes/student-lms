      ...
      <ModalContent className="max-w-[480px]">
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          <button
            ...
            className="rounded-[12px] bg-gradient-to-r from-accent-warm to-[#FF7A29] dark:to-[#c9302b] px-5 py-2.5 text-[14px] font-bold text-accent-warm-foreground shadow-[0_8px_20px_-6px_rgba(242,92,4,0.5)] dark:shadow-[0_8px_20px_-6px_rgba(244,69,63,0.45)] transition-all hover:shadow-[0_10px_26px_-6px_rgba(242,92,4,0.6)] dark:hover:shadow-[0_10px_26px_-6px_rgba(244,69,63,0.55)] active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none"
          >
            {confirmLabel}
          </button>
        </div>
