...
export function LectureDiscussionReplyForm({
  ...
  return (
    <form
      className={cn(
        'space-y-3 rounded-lg border border-border bg-surface-muted/50 p-3',
        className,
      )}
      onSubmit={(e) => {
        e.preventDefault()
    ...
    >
      <div className="space-y-1.5">
        ...
        <RichTextEditor
          ...
          className="rounded-lg border border-border bg-surface transition-[border-color,box-shadow] duration-200 focus-within:border-brand/50 focus-within:ring-2 focus-within:ring-brand/15"
        />
