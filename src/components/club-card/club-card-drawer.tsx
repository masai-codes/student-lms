        ...
        >
          <div className="flex items-start justify-between gap-3 border-b p-4">
            <div className="min-w-0 flex-1">
              <p className="break-words text-xs font-semibold uppercase tracking-wide text-foreground-muted">
                {resolvedDomain}
              </p>
              <Dialog.Title className="mt-1 break-words text-lg font-semibold text-foreground">
                About the Club
              </Dialog.Title>
            </div>
          ...
          <div className="flex min-h-0 flex-1 flex-col p-4">
            <div className="bg-[#EBF5FF] flex py-[32px] rounded-[8px] dark:bg-info-subtle">
              <img
                src={imageUrl}
                alt={resolvedName}
            ...
            >
              <p className="break-words text-[18px] font-[600] leading-[28px] font-poppins text-foreground">
                {resolvedName}
              </p>
              <RichContent
                value={detailDescription}
                className="mt-[8px] text-[14px] font-[400] leading-[20px] font-poppins text-foreground [&_a]:underline [&_ol]:list-decimal [&_ol]:pl-5 [&_p]:mb-3 [&_p:last-child]:mb-0 [&_ul]:list-disc [&_ul]:pl-5"
              />
              {memberCount !== null ? (
              ...
              {detailPoints.length > 0 ? (
                <div className="mt-[32px]">
                  <h4 className="text-[14px] font-[600] leading-[20px] font-poppins text-foreground">
                    What you’ll do here
                  </h4>
                  <ul className="mt-[12px] list-disc gap-[4px] pl-5 text-[14px] font-[400] leading-[24px] font-poppins text-foreground">
