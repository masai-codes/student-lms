...
export const adhocSessionApprovers = mysqlTable(
  'adhoc_session_approvers',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    adhocSessionId: int('adhoc_session_id', { unsigned: true })
      .notNull()
...
export const adhocSessionBatches = mysqlTable(
  'adhoc_session_batches',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    adhocSessionId: int('adhoc_session_id', { unsigned: true })
      .notNull()
...
export const adhocSessionBlocks = mysqlTable(
  'adhoc_session_blocks',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    adhocSessionId: int('adhoc_session_id', { unsigned: true })
      .notNull()
      .references(() => adhocSessions.id),
    blockId: int('block_id', { unsigned: true })
      .notNull()
...
export const adhocSessionBlueprints = mysqlTable(
  'adhoc_session_blueprints',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
...
export const adhocSessionSections = mysqlTable(
  'adhoc_session_sections',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    adhocSessionId: int('adhoc_session_id', { unsigned: true })
      .notNull()
...
export const adhocSessionUsers = mysqlTable(
  'adhoc_session_users',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    adhocSessionId: int('adhoc_session_id', { unsigned: true })
...
export const adhocSessions = mysqlTable(
  'adhoc_sessions',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    name: varchar({ length: 255 }).notNull(),
    ...
    adhocSessionBlueprintId: int('adhoc_session_blueprint_id', {
      unsigned: true,
    }).references(() => adhocSessionBlueprints.id),
    createdAt: timestamp('created_at', { mode: 'string' }),
    updatedAt: timestamp('updated_at', { mode: 'string' }),
  },
  (table) => [primaryKey({ columns: [table.id], name: 'adhoc_sessions_id' })],
)
...
export const aiFeedback = mysqlTable(
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'ai_feedback_id' })],
)

export const aiPracticeQuestions = mysqlTable(
...
export const algorithms = mysqlTable(
  'algorithms',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    createdAt: timestamp('created_at', { mode: 'string' }),
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'algorithms_id' })],
)
...
export const answers = mysqlTable(
  ...
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    attemptId: int('attempt_id', { unsigned: true })
      .notNull()
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'answers_id' })],
)

export const appConfigs = mysqlTable(
  'app_configs',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
  ...
  (table) => [
    ...
    unique('app_configs_appName_platform_unique').on(
      table.appName,
      table.platform,
    ),
  ],
...
export const appFeatureConfigurations = mysqlTable(
  'app_feature_configurations',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    appName: varchar({ length: 100 }).notNull(),
  ...
  (table) => [
    ...
    unique('app_feature_config_app_feature_platform_unique').on(
      table.appName,
      table.featureKey,
      table.platform,
    ),
...
export const applicationComments = mysqlTable(
...
export const applicationHistories = mysqlTable(
...
export const applications = mysqlTable(
  'applications',
  {
    ...
    offerLetterSentToOpsAt: datetime('offer_letter_sent_to_ops_at', {
      mode: 'string',
    }),
    data: json().$type<Record<string, any>>(),
    info: json().$type<Record<string, any>>(),
...
export const approvals = mysqlTable(
  'approvals',
  {
    ...
    status: mysqlEnum(['approved', 'rejected', 'pending'])
      .default('pending')
      .notNull(),
    approverId: bigint('approver_id', {
      mode: 'number',
      unsigned: true,
    }).notNull(),
  ...
  (table) => [
    ...
    index('approvals_entity_type_entity_id_index').on(
      table.entityType,
      table.entityId,
    ),
...
export const assignmentBlueprints = mysqlTable(
  'assignment_blueprints',
  {
    ...
    blueprintId: bigint('blueprint_id', { mode: 'number', unsigned: true })
      .notNull()
    ...
    assignmentId: int('assignment_id', { unsigned: true }).references(
      () => assignments.id,
      { onDelete: 'cascade' },
    ),
...
export const assignmentBlueprintsProblems = mysqlTable(
  'assignment_blueprints_problems',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    assignmentBlueprintId: bigint('assignment_blueprint_id', {
      mode: 'number',
      unsigned: true,
    })
      .notNull()
      .references(() => assignmentBlueprints.id, { onDelete: 'cascade' }),
  ...
  (table) => [
    primaryKey({
      columns: [table.id],
      name: 'assignment_blueprints_problems_id',
    }),
  ],
)
...
export const attempts = mysqlTable(
  ...
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    quizId: int('quiz_id', { unsigned: true })
      .notNull()
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'attempts_id' })],
)
...
export const batchInfo = mysqlTable(
  'batch_info',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    batchId: int('batch_id', { unsigned: true })
    ...
    value: text(),
    makerId: bigint('maker_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => users.id),
    checkerId: bigint('checker_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => users.id),
    ...
    createdAt: timestamp('created_at', { mode: 'string' })
      ...
      .notNull(),
    updatedAt: timestamp('updated_at', { mode: 'string' }).notNull(),
    stageId: bigint('stage_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => batchInfoStages.id, { onDelete: 'cascade' }),
...
export const batchInfoApprovers = mysqlTable(
  'batch_info_approvers',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    stageId: bigint('stage_id', { mode: 'number', unsigned: true })
      .notNull()
  ...
  (table) => [
    ...
    unique('batch_info_approvers_stage_user_unique').on(
      table.stageId,
      table.userId,
    ),
  ],
...
export const batchInfoHistory = mysqlTable(
  'batch_info_history',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    batchId: int('batch_id', { unsigned: true })
  ...
  (table) => [
    index('batch_info_history_batch_id_entity_id_idx').on(
      table.batchId,
      table.entityId,
    ),
...
export const batchInfoStages = mysqlTable(
  'batch_info_stages',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    batchId: int('batch_id', { unsigned: true })
...
export const batchInfoTemplateItems = mysqlTable(
  'batch_info_template_items',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    batchInfoTemplateId: bigint('batch_info_template_id', {
      mode: 'number',
      unsigned: true,
    })
      .notNull()
      .references(() => batchInfoTemplates.id, { onDelete: 'cascade' }),
    item: varchar({ length: 255 }).notNull(),
    type: varchar({ length: 50 }).notNull(),
    meta: json().$type<Record<string, any>>(),
    createdAt: timestamp('created_at', { mode: 'string' })
  ...
  (table) => [
    index('batch_info_template_items_batch_info_template_id_idx').on(
      table.batchInfoTemplateId,
    ),
...
export const batchInfoTemplates = mysqlTable(
  'batch_info_templates',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    title: varchar({ length: 255 }).notNull(),
    description: text(),
...
export const batchParticipants = mysqlTable(
  'batch_participants',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    lectureId: int('lecture_id', { unsigned: true })
...
export const batchQcReports = mysqlTable(
  'batch_qc_reports',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
...
export const batchUserStatusLogs = mysqlTable(
  'batch_user_status_logs',
  {
    id: int().autoincrement().notNull(),
    createdAt: timestamp('created_at', { mode: 'string' }).default(
      sql`CURRENT_TIMESTAMP`,
...
export const blockDraftUnitMovements = mysqlTable(
  'block_draft_unit_movements',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    draftUnitMovementId: bigint('draft_unit_movement_id', {
      mode: 'number',
      unsigned: true,
    }).references(() => draftUnitMovements.id, { onDelete: 'cascade' }),
    ...
    newSectionId: int('new_section_id', { unsigned: true }).references(
      () => sections.id,
      { onDelete: 'cascade' },
    ),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
    ...
    newSectionSuspectList: tinyint('new_section_suspect_list')
      .default(0)
      .notNull(),
  },
  (table) => [
...
export const blockUnitMovementEmailTemplates = mysqlTable(
  'block_unit_movement_email_templates',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    name: varchar({ length: 255 }).notNull(),
  ...
  (table) => [
    primaryKey({
      columns: [table.id],
      name: 'block_unit_movement_email_templates_id',
    }),
  ],
)

export const blockUnitMovementEmails = mysqlTable(
  'block_unit_movement_emails',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    name: varchar({ length: 255 }).notNull(),
    body: longtext().notNull(),
...
export const blueprints = mysqlTable(
  'blueprints',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    name: varchar({ length: 255 }).notNull(),
    ...
    type: varchar({ length: 255 }).notNull(),
    settings: json().$type<Record<string, any>>(),
    assignmentPercentageWeightage: int(
      'assignment_percentage_weightage',
    ).notNull(),
    attendancePercentageWeightage: int(
      'attendance_percentage_weightage',
    ).notNull(),
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'blueprints_id' })],
)
...
export const bountyPrograms = mysqlTable(
  'bounty_programs',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    username: varchar({ length: 255 }).notNull(),
    bountiesWon: bigint('bounties_won', {
      mode: 'number',
      unsigned: true,
    }).notNull(),
...
export const briefingsDebriefings = mysqlTable(
  'briefings_debriefings',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    ...
    data: json().$type<Record<string, any>>(),
    notes: text(),
    curriculumPocId: bigint('curriculum_poc_id', {
      mode: 'number',
      unsigned: true,
    }),
  ...
  (table) => [
    index('briefings_debriefings_curriculum_poc_id_foreign').on(
      table.curriculumPocId,
    ),
...
export const certificateTemplateConfig = mysqlTable(
...
export const certificateUserRelation = mysqlTable(
  'certificate_user_relation',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    certificateId: int('certificate_id', { unsigned: true })
      .notNull()
  ...
  (table) => [
    ...
    index('certificate_user_relation_certificate_id_index').on(
      table.certificateId,
    ),
    ...
    unique('certificate_user_relation_unique').on(
      table.certificateId,
      table.userId,
      table.batchId,
    ),
...
export const certificates = mysqlTable(
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'certificates_id' })],
)

export const certificatesBatchStudents = mysqlTable(
  'certificates_batch_students',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    batchId: int('batch_id', { unsigned: true })
      .notNull()
  ...
  (table) => [
    ...
    unique('certificates_batch_students_certificate_object_id_unique').on(
      table.certificateObjectId,
    ),
  ],
)

export const certificatesEmailTemplates = mysqlTable(
  ...
  (table) => [
    ...
    index('certificates_email_templates_template_name_index').on(
      table.templateName,
    ),
    index('certificates_email_templates_updated_by_index').on(table.updatedBy),
    primaryKey({
      columns: [table.id],
      name: 'certificates_email_templates_id',
    }),
  ],
)

export const certificatesTemplateBatch = mysqlTable(
  'certificates_template_batch',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    templateId: int('template_id', { unsigned: true })
      .notNull()
...
export const clubPostBookmarks = mysqlTable(
  'club_post_bookmarks',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
  ...
  (table) => [
    ...
    unique('club_post_bookmarks_user_id_post_id_unique').on(
      table.userId,
      table.postId,
    ),
  ],
...
export const companies = mysqlTable(
  'companies',
  {
    ...
    organizationHeadquarters: varchar('organization_headquarters', {
      length: 255,
    }),
...
export const disbursalStatuses = mysqlTable(
  'disbursal_statuses',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
  ...
  (table) => [
    index('disbursal_statuses_entity_type_entity_id_index').on(
      table.entityType,
      table.entityId,
    ),
...
export const draftUnitMovements = mysqlTable(
  'draft_unit_movements',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    unitMovementRuleId: bigint('unit_movement_rule_id', {
      mode: 'number',
      unsigned: true,
    }).references(() => unitMovementRules.id, { onDelete: 'cascade' }),
    sectionId: int('section_id', { unsigned: true }).references(
      () => sections.id,
      { onDelete: 'cascade' },
    ),
...
export const eeCycleRecords = mysqlTable(
  'ee_cycle_records',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    ...
    createdAt: timestamp('created_at', { mode: 'string' })
      ...
      .notNull(),
    updatedAt: timestamp('updated_at', { mode: 'string' }).notNull(),
    generatedPayoutInvoice: varchar('generated_payout_invoice', {
      length: 2048,
    }),
    invoiceGenerationStatus: mysqlEnum('invoice_generation_status', [
      'Pending',
      'InProgress',
      'Failed',
      'Generated',
  ...
  (table) => [
    ...
    unique('ee_cycle_records_ee_id_cycle_id_unique').on(
      table.eeId,
      table.cycleId,
    ),
  ],
...
export const eeEngagementCosts = mysqlTable(
  'ee_engagement_costs',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    eeId: int('ee_id', { unsigned: true })
      .notNull()
    ...
    variableCost: decimal('variable_cost', {
      precision: 10,
      scale: 2,
    }).notNull(),
    createdAt: timestamp('created_at', { mode: 'string' })
  ...
  (table) => [
    ...
    unique('ee_engagement_costs_ee_id_engagement_type_key').on(
      table.eeId,
...
export const eeLeaveRequests = mysqlTable(
  'ee_leave_requests',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    eeId: int('ee_id', { unsigned: true }).notNull(),
  ...
  (table) => [
    index('ee_leave_requests_date_range_index').on(
      table.startDate,
      table.endDate,
    ),
...
export const eeOnboardingForm = mysqlTable(
  'ee_onboarding_form',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
    ...
    marketingWebsiteAcknowledgement: tinyint(
      'marketing_website_acknowledgement',
    )
      .default(0)
      .notNull(),
    ...
    panDocumentOriginalFilename: varchar('pan_document_original_filename', {
      length: 255,
    }),
    ...
    bankProofOriginalFilename: varchar('bank_proof_original_filename', {
      length: 255,
    }),
...
export const eePayoutHistories = mysqlTable(
  'ee_payout_histories',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
  ...
  (table) => [
    ...
    unique('payout_history_unique_lecture_user_ee_type').on(
      table.lectureId,
      table.userId,
      table.eeId,
      table.type,
...
export const eeSectionMapping = mysqlTable(
  'ee_section_mapping',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    eeId: int('ee_id', { unsigned: true }).notNull(),
  ...
  (table) => [
    ...
    unique('ee_section_mapping_ee_id_section_id_unique').on(
      table.eeId,
      table.sectionId,
    ),
  ],
...
export const electiveEntity = mysqlTable(
  'elective_entity',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    electiveId: int('elective_id', { unsigned: true })
      .notNull()
  ...
  (table) => [
    index('elective_entity_entity_type_entity_id_index').on(
      table.entityType,
      table.entityId,
    ),
...
export const electiveProgress = mysqlTable(
  'elective_progress',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    electiveUserId: int('elective_user_id', { unsigned: true })
      .notNull()
      .references(() => electiveUser.id),
    electiveEntityId: int('elective_entity_id', { unsigned: true })
      .notNull()
...
export const electiveSection = mysqlTable(
  'elective_section',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    electiveId: int('elective_id', { unsigned: true })
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'elective_section_id' })],
)

export const electiveUser = mysqlTable(
  'elective_user',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    electiveId: int('elective_id', { unsigned: true })
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'elective_user_id' })],
)

export const electives = mysqlTable(
  'electives',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    title: varchar({ length: 255 }).notNull(),
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'electives_id' })],
)

export const eligibilities = mysqlTable(
  'eligibilities',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'eligibilities_id' })],
)

export const emailNotificationLogs = mysqlTable(
  ...
  (table) => [
    ...
    index('email_notification_logs_entity_index').on(
      table.entityId,
      table.notificationType,
    ),
    index('email_notification_logs_ses_message_id_index').on(
      table.sesMessageId,
    ),
    ...
    unique('email_notification_logs_unique').on(
      table.userId,
      table.entityId,
      table.notificationType,
    ),
...
export const externalEmployees = mysqlTable(
  'external_employees',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true }).notNull(),
  ...
  (table) => [
    index('external_employees_contract_end_date_index').on(
...
export const externalOffers = mysqlTable(
  'external_offers',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    status: varchar({ length: 255 }),
    ...
    data: json().$type<Record<string, any>>(),
    info: json().$type<Record<string, any>>(),
    leadId: bigint('lead_id', { mode: 'number', unsigned: true }).references(
      () => leads.id,
    ),
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'external_offers_id' })],
)

export const externalProblemSubmissions = mysqlTable(
  'external_problem_submissions',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    createdAt: timestamp('created_at', { mode: 'string' }),
    updatedAt: timestamp('updated_at', { mode: 'string' }),
  ...
  (table) => [
    primaryKey({
      columns: [table.id],
      name: 'external_problem_submissions_id',
    }),
    unique('external_problem_submissions_external_id_platform_unique').on(
      table.externalId,
      table.platform,
    ),
  ],
...
export const feedbackGptCentral = mysqlTable(
  'feedback_gpt_central',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true }).notNull(),
    entityType: varchar('entity_type', { length: 255 }).notNull(),
...
export const feedbackQuestionBlueprints = mysqlTable(
  'feedback_question_blueprints',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    feedbackBlueprintId: bigint('feedback_blueprint_id', {
      mode: 'number',
  ...
  (table) => [
    primaryKey({
      columns: [table.id],
      name: 'feedback_question_blueprints_id',
    }),
  ],
)
...
export const feedbackQuestions = mysqlTable(
  ...
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    feedbackId: bigint('feedback_id', { mode: 'number', unsigned: true })
      .notNull()
    ...
    range: json().$type<Record<string, any>>(),
    settings: json().$type<Record<string, any>>(),
    feedbackQuestionBlueprintId: bigint('feedback_question_blueprint_id', {
      mode: 'number',
      unsigned: true,
...
export const feedbackResponses = mysqlTable(
  'feedback_responses',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    feedbackId: bigint('feedback_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => feedback.id),
    feedbackQuestionId: bigint('feedback_question_id', {
      mode: 'number',
      unsigned: true,
    })
      .notNull()
...
export const flagQuery = mysqlTable(
  'flag_query',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    flagId: bigint('flag_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => flags.id),
    queryId: bigint('query_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => queries.id),
    createdAt: timestamp('created_at', { mode: 'string' }),
    updatedAt: timestamp('updated_at', { mode: 'string' }),
  },
  (table) => [primaryKey({ columns: [table.id], name: 'flag_query_id' })],
)
...
export const flags = mysqlTable(
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'flags_id' })],
)

export const githubs = mysqlTable(
  'githubs',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
...
export const guardian = mysqlTable(
  ...
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    guardianId: bigint('guardian_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => users.id),
    name: varchar({ length: 255 }).notNull(),
    email: varchar({ length: 255 }),
...
export const guardianOtp = mysqlTable(
  'guardian_otp',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
...
export const instituteBatches = mysqlTable(
  'institute_batches',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    instituteId: int('institute_id', { unsigned: true })
      .notNull()
  ...
  (table) => [
    ...
    unique('institute_batches_institute_batch_unique').on(
      table.instituteId,
      table.batchId,
    ),
  ],
...
export const institutes = mysqlTable(
  'institutes',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    name: varchar({ length: 255 }).notNull(),
...
export const interactionMessages = mysqlTable(
  'interaction_messages',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    interactionId: int('interaction_id', { unsigned: true })
      .notNull()
...
export const interactions = mysqlTable(
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'interactions_id' })],
)

export const interviewprimeAssessments = mysqlTable(
  'interviewprime_assessments',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true }).notNull(),
    score: varchar({ length: 255 }),
...
export const interviews = mysqlTable(
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'interviews_id' })],
)
...
export const leads = mysqlTable(
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'leads_id' })],
)

export const learningObjectives = mysqlTable(
  'learning_objectives',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
...
export const lectureAiGeneratedContent = mysqlTable(
  'lecture_ai_generated_content',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    lectureId: int('lecture_id', { unsigned: true })
      .notNull()
  ...
  (table) => [
    primaryKey({
      columns: [table.id],
      name: 'lecture_ai_generated_content_id',
    }),
  ],
)

export const lectureBlueprints = mysqlTable(
  'lecture_blueprints',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    title: varchar({ length: 255 }).notNull(),
    ...
    vimeoDownloadLinks: json('vimeo_download_links').$type<
      Record<string, any>
    >(),
    lectureId: int('lecture_id', { unsigned: true }).references(
      () => lectures.id,
      { onDelete: 'cascade' },
    ),
    scheduledTime: time('scheduled_time'),
    ...
    createdAt: timestamp('created_at', { mode: 'string' }),
    updatedAt: timestamp('updated_at', { mode: 'string' }),
    sectionFeedbackBlueprintId: bigint('section_feedback_blueprint_id', {
      mode: 'number',
      unsigned: true,
...
export const lectureInteractions = mysqlTable(
  'lecture_interactions',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    lectureId: int('lecture_id', { unsigned: true })
      .notNull()
    ...
    contentScrollPercentage: tinyint('content_scroll_percentage', {
      unsigned: true,
    }),
  ...
  (table) => [
    ...
    unique('lecture_interactions_lecture_user_unique').on(
      table.lectureId,
      table.userId,
    ),
  ],
...
export const lectureParticipants = mysqlTable(
  'lecture_participants',
  {
    ...
    eeId: int('ee_id', { unsigned: true })
      .notNull()
      .references(() => externalEmployees.id),
    eeRateType: varchar('ee_rate_type', { length: 191 })
      .default('LiveSession')
      .notNull(),
...
export const lecturesCourse = mysqlTable(
  'lectures_course',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    title: varchar({ length: 255 }).notNull(),
...
export const media = mysqlTable(
  ...
  (table) => [
    index('media_entity_type_entity_id_index').on(
      table.entityType,
      table.entityId,
    ),
...
export const npsForms = mysqlTable(
  'nps_forms',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    ...
    startsAt: datetime('starts_at', { mode: 'string' }),
    endsAt: datetime('ends_at', { mode: 'string' }),
    status: mysqlEnum(['DRAFT', 'PUBLISHED', 'CLOSED'])
      .default('DRAFT')
      .notNull(),
    isActive: tinyint('is_active').default(1).notNull(),
    allowMultipleAttempts: tinyint('allow_multiple_attempts')
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'nps_forms_id' })],
)

export const npsQuestionResponses = mysqlTable(
  'nps_question_responses',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    npsSubmissionId: int('nps_submission_id', { unsigned: true })
      .notNull()
      .references(() => npsSubmissions.id, { onDelete: 'cascade' }),
    npsQuestionId: int('nps_question_id', { unsigned: true })
      .notNull()
      .references(() => npsQuestions.id, { onDelete: 'cascade' }),
  ...
  (table) => [
    ...
    unique(
      'nps_question_responses_nps_submission_id_nps_question_id_unique',
    ).on(table.npsSubmissionId, table.npsQuestionId),
  ],
)

export const npsQuestions = mysqlTable(
  'nps_questions',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    npsFormId: int('nps_form_id', { unsigned: true })
      .notNull()
      .references(() => npsForms.id, { onDelete: 'cascade' }),
  ...
  (table) => [
    index('nps_questions_nps_form_id_sequence_index').on(
      table.npsFormId,
      table.sequence,
    ),
...
export const npsSubmissions = mysqlTable(
  'nps_submissions',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    npsFormId: int('nps_form_id', { unsigned: true })
    ...
    status: mysqlEnum(['DRAFT', 'SUBMITTED', 'ABANDONED'])
      .default('DRAFT')
      .notNull(),
  ...
  (table) => [
    ...
    unique('nps_submissions_nps_form_id_user_id_attempt_number_unique').on(
      table.npsFormId,
      table.userId,
      table.attemptNumber,
    ),
...
export const oldCertsDumpBatches = mysqlTable(
  'old_certs_dump_batches',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    ...
    visibleVerificationFields: json('visible_verification_fields').$type<
      Record<string, any>
    >(),
  },
  (table) => [
...
export const oldCertsDumpCertificates = mysqlTable(
  'old_certs_dump_certificates',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    certificateId: varchar('certificate_id', { length: 255 }).notNull(),
    batchId: int('batch_id', { unsigned: true }).references(
      () => oldCertsDumpBatches.id,
  ...
  (table) => [
    ...
    index('old_certs_dump_certificates_certificate_id_idx').on(
      table.certificateId,
    ),
    primaryKey({ columns: [table.id], name: 'old_certs_dump_certificates_id' }),
    unique('old_certs_dump_certificates_certificate_id_key').on(
      table.certificateId,
    ),
  ],
)

export const onboardingCallSummaries = mysqlTable(
  'onboarding_call_summaries',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true }),
  ...
  (table) => [
    ...
    index('onboarding_call_summaries_conversation_id_index').on(
...
export const opinions = mysqlTable(
  'opinions',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    title: varchar({ length: 255 }),
  ...
  (table) => [
    index('opinions_entity_type_entity_id_index').on(
      table.entityType,
      table.entityId,
    ),
...
export const payoutCycles = mysqlTable(
  'payout_cycles',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
...
export const placementStatuses = mysqlTable(
  'placement_statuses',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
  ...
  (table) => [
    index('placement_statuses_entity_type_entity_id_index').on(
      table.entityType,
      table.entityId,
    ),
...
export const placementTags = mysqlTable(
  'placement_tags',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    name: varchar({ length: 255 }).notNull(),
    taggableType: varchar('taggable_type', { length: 255 }).notNull(),
    taggableId: bigint('taggable_id', {
      mode: 'number',
      unsigned: true,
    }).notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
  ...
  (table) => [
    index('placement_tags_taggable_type_taggable_id_index').on(
      table.taggableType,
      table.taggableId,
    ),
...
export const portfolioFeedback = mysqlTable(
  'portfolio_feedback',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    createdAt: timestamp('created_at', { mode: 'string' }),
...
export const portfolioStudentIas = mysqlTable(
  'portfolio_student_ias',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    createdAt: timestamp('created_at', { mode: 'string' }),
    updatedAt: timestamp('updated_at', { mode: 'string' }),
    studentId: bigint('student_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => users.id),
    iaId: bigint('ia_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => users.id),
...
export const portfolioSubmissions = mysqlTable(
  'portfolio_submissions',
  {
    ...
    status: varchar({ length: 255 }),
    score: int(),
    raisedForFeedback: mysqlEnum(['Unraised', 'Raised', 'Closed'])
      .default('Unraised')
      .notNull(),
...
export const positionParams = mysqlTable(
  'position_params',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    positionId: bigint('position_id', { mode: 'number', unsigned: true })
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'position_params_id' })],
)
...
export const positions = mysqlTable(
  'positions',
  {
    ...
    companyId: bigint('company_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => companies.id),
    eligibilityId: bigint('eligibility_id', { mode: 'number', unsigned: true })
      .notNull()
    ...
    offlineInterviewLocation: varchar('offline_interview_location', {
      length: 255,
    }),
    eligibleTechStacks: json('eligible_tech_stacks').$type<
      Record<string, any>
    >(),
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'positions_id' })],
)

export const positionsHistories = mysqlTable(
  'positions_histories',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    positionId: bigint('position_id', { mode: 'number', unsigned: true })
...
export const practiceInterviewTemplates = mysqlTable(
  'practice_interview_templates',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    title: varchar({ length: 255 }).notNull(),
  ...
  (table) => [
    ...
    primaryKey({
      columns: [table.id],
      name: 'practice_interview_templates_id',
    }),
  ],
)

export const practiceInterviews = mysqlTable(
  'practice_interviews',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
...
export const practiceQuizResponses = mysqlTable(
  'practice_quiz_responses',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
      .notNull()
    ...
    createdAt: timestamp('created_at', { mode: 'string' }),
    updatedAt: timestamp('updated_at', { mode: 'string' }),
    activePracticeSession: int('active_practice_session', { unsigned: true })
      .default(1)
      .notNull(),
  },
  (table) => [
...
export const practiceTestQuestions = mysqlTable(
  'practice_test_questions',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    name: varchar({ length: 255 }).notNull(),
    assessQuestionId: varchar({ length: 255 }).notNull(),
    practiceSubTopicId: int('practice_sub_topic_id', { unsigned: true })
      .notNull()
...
export const practiceTestQuestionsUsersAttempted = mysqlTable(
  'practice_test_questions_users_attempted',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => users.id),
    practiceTestQuestionId: int('practice_test_question_id', { unsigned: true })
      .notNull()
  ...
  (table) => [
    primaryKey({
      columns: [table.id],
      name: 'practice_test_questions_users_attempted_id',
    }),
  ],
)

export const practiceTestSubTopics = mysqlTable(
  'practice_test_sub_topics',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    name: varchar({ length: 255 }).notNull(),
    practiceTopicId: int('practice_topic_id', { unsigned: true })
      .notNull()
...
export const practiceTestTopics = mysqlTable(
...
export const prepaidAgreements = mysqlTable(
  'prepaid_agreements',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    batchId: int('batch_id').notNull(),
  ...
  (table) => [
    index('idx_prepaid_agreements_batch_created_at').on(
      table.batchId,
      table.createdAt,
    ),
...
export const problemLinks = mysqlTable(
  'problem_links',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    createdAt: timestamp('created_at', { mode: 'string' }),
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'problem_links_id' })],
)
...
export const profileVerifies = mysqlTable(
  'profile_verifies',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'profile_verifies_id' })],
)
...
export const queries = mysqlTable(
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'queries_id' })],
)

export const queryComments = mysqlTable(
  'query_comments',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    queryId: bigint('query_id', { mode: 'number', unsigned: true })
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'query_comments_id' })],
)

export const questionQuiz = mysqlTable(
  'question_quiz',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    quizId: int('quiz_id', { unsigned: true })
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'question_quiz_id' })],
)
...
export const questions = mysqlTable(
  'questions',
  {
    ...
    tags: varchar({ length: 255 }),
    explanation: text(),
    type: mysqlEnum(['MC', 'SHORT', 'LONG', 'TF', 'SC'])
      .default('MC')
      .notNull(),
    marks: tinyint({ unsigned: true }).default(1).notNull(),
    timing: smallint({ unsigned: true }).notNull(),
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'questions_id' })],
)

export const quizBlueprints = mysqlTable(
  'quiz_blueprints',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    title: varchar({ length: 255 }).notNull(),
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'quiz_blueprints_id' })],
)

export const quizBlueprintsQuestions = mysqlTable(
  'quiz_blueprints_questions',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    quizBlueprintId: bigint('quiz_blueprint_id', {
      mode: 'number',
      unsigned: true,
    })
      .notNull()
      .references(() => quizBlueprints.id, { onDelete: 'cascade' }),
    questionId: int('question_id', { unsigned: true })
      .notNull()
...
export const rbacPermissions = mysqlTable(
  'rbac_permissions',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
  ...
  (table) => [
    ...
    unique('rbac_permissions_resource_action_key').on(
      table.resource,
      table.action,
    ),
  ],
...
export const rbacRolePermissions = mysqlTable(
  ...
  (table) => [
    ...
    unique('rbac_role_permissions_role_id_permission_id_key').on(
      table.roleId,
      table.permissionId,
    ),
  ],
...
export const rbacRoles = mysqlTable(
  'rbac_roles',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    name: varchar({ length: 100 }).notNull(),
...
export const rbacUserRoles = mysqlTable(
  ...
  (table) => [
    ...
    unique(
      'rbac_user_roles_user_id_role_id_scope_type_batch_id_section__key',
    ).on(
      table.userId,
      table.roleId,
      table.scopeType,
...
export const scenes = mysqlTable(
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'scenes_id' })],
)

export const sectionFeedbackBlueprints = mysqlTable(
  'section_feedback_blueprints',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    name: varchar({ length: 255 }).notNull(),
    variables: json()
    ...
    blueprintId: bigint('blueprint_id', {
      mode: 'number',
      unsigned: true,
...
export const sectionUserCourse = mysqlTable(
  'section_user_course',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    sectionId: int('section_id', { unsigned: true }).notNull(),
...
export const segments = mysqlTable(
  ...
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    sceneId: int('scene_id', { unsigned: true })
      .notNull()
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'segments_id' })],
)
...
export const slackBroadcasts = mysqlTable(
  'slack_broadcasts',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'slack_broadcasts_id' })],
)

export const slackMessageHistories = mysqlTable(
  'slack_message_histories',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    slackBroadcastId: bigint('slack_broadcast_id', {
      mode: 'number',
      unsigned: true,
    }).notNull(),
  ...
  (table) => [
    index('slack_message_histories_slack_broadcast_id_foreign').on(
      table.slackBroadcastId,
    ),
    primaryKey({ columns: [table.id], name: 'slack_message_histories_id' }),
  ],
)

export const slackTeams = mysqlTable(
  'slack_teams',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    teamId: varchar('team_id', { length: 255 }).notNull(),
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'slack_teams_id' })],
)
...
export const studentTagCategories = mysqlTable(
  'student_tag_categories',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    category: varchar({ length: 255 }).notNull(),
    active: tinyint().default(1).notNull(),
...
export const studentTagNames = mysqlTable(
  'student_tag_names',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    name: varchar({ length: 255 }).notNull(),
...
export const studentTagRelation = mysqlTable(
  'student_tag_relation',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    nameId: int('name_id', { unsigned: true })
      .notNull()
      .references(() => studentTagNames.id),
    typeId: int('type_id', { unsigned: true })
      .notNull()
...
export const studentTagTypes = mysqlTable(
  'student_tag_types',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    type: varchar({ length: 255 }).notNull(),
...
export const ticketTemplates = mysqlTable(
  'ticket_templates',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
...
export const topicObjectives = mysqlTable(
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'topic_objectives_id' })],
)

export const unitMovementRules = mysqlTable(
  'unit_movement_rules',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    sectionId: int('section_id', { unsigned: true })
...
export const unitMovementUserDetails = mysqlTable(
  'unit_movement_user_details',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
      .notNull()
...
export const userBlockEmails = mysqlTable(
  'user_block_emails',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
      ...
      .references(() => users.id),
    blockId: int('block_id', { unsigned: true }).references(() => blocks.id),
    blockUnitMovementEmailId: bigint('block_unit_movement_email_id', {
      mode: 'number',
      unsigned: true,
    })
      .notNull()
...
export const userCertificates = mysqlTable(
  ...
  (table) => [
    ...
    unique('unique_user_batch_type').on(
      table.userId,
      table.batchId,
...
export const userDocuments = mysqlTable(
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'user_documents_id' })],
)

export const userGuardian = mysqlTable(
  'user_guardian',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    guardianId: bigint('guardian_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => guardian.guardianId, { onDelete: 'cascade' }),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => users.id, { onDelete: 'cascade' }),
    createdAt: timestamp('created_at', { mode: 'string' }),
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'user_guardian_id' })],
)

export const userRelation = mysqlTable(
  'user_relation',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
      .notNull()
      .references(() => users.id),
    relationId: int('relation_id', { unsigned: true })
      .notNull()
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'user_relation_id' })],
)

export const userRelationHistory = mysqlTable(
  'user_relation_history',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    userRelationId: int('user_relation_id', { unsigned: true })
      .notNull()
...
export const userScenes = mysqlTable(
  'user_scenes',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'user_scenes_id' })],
)

export const userSegments = mysqlTable(
  'user_segments',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    userId: bigint('user_id', { mode: 'number', unsigned: true })
  ...
  (table) => [primaryKey({ columns: [table.id], name: 'user_segments_id' })],
)
...
export const viPptLogs = mysqlTable(
  'vi_ppt_logs',
  {
    id: bigint({ mode: 'number', unsigned: true }).autoincrement().notNull(),
    batchId: int('batch_id').notNull(),
  ...
  (table) => [
    index('idx_virtual_inaugural_ppts_batch_created_at').on(
      table.batchId,
      table.createdAt,
    ),
...
export const zefFeedbackRating = mysqlTable(
  'zef_feedback_rating',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    zefMetaDataId: int('zef_meta_data_id', { unsigned: true })
      .notNull()
      .references(() => zefMetaData.id, { onDelete: 'cascade' }),
  ...
  (table) => [
    ...
    unique('zef_feedback_rating_meta_zef_id_unique').on(
      table.zefMetaDataId,
      table.zefId,
    ),
  ],
...
export const zefMetaData = mysqlTable(
  'zef_meta_data',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    lectureId: int('lecture_id', { unsigned: true })
    ...
    participantsCount: int('participants_count', { unsigned: true })
      .default(0)
      .notNull(),
...
export const zefPoll = mysqlTable(
  'zef_poll',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    zefMetaDataId: int('zef_meta_data_id', { unsigned: true })
...
export const zefQuiz = mysqlTable(
  'zef_quiz',
  {
    id: int({ unsigned: true }).autoincrement().notNull(),
    zefMetaDataId: int('zef_meta_data_id', { unsigned: true })
