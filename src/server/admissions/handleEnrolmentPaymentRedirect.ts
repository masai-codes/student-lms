 ...
 * then 302s to the admissions `/lms-login` enrolment-payment flow. Any failure
 * (no session, bad/ineligible enrolment, SSO unconfigured) bounces back to the
 * dashboard rather than surfacing an error page in the new tab.
 */
